...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    budget_value = exchange_money( budget, exchange_rate)
    max_exchange_value = budget_value*(100 - spread)/100
    return get_number_of_bills( max_exchange_value, denomination)
