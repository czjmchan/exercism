...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    new_exchange_rate = exchange_rate * (100 + spread) / 100
    budget_value = exchange_money( budget, new_exchange_rate)
    num_of_bills = get_number_of_bills( budget_value, denomination)
    return num_of_bills * denomination
